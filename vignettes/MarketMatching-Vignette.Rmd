...
Plot the cumulative impact. The posterior interval includes zero as expected, which means that the deviation is likely noise:
```{r, echo = TRUE, message=FALSE, eval=TRUE, fig.width=7, fig.height=5}
results$PlotCumulativeEffect
```

Although some of the dips in the *pointwise* effects toward the end of the post period seem to be truly negative:
```{r, echo = TRUE, message=FALSE, eval=TRUE, fig.width=7, fig.height=5}

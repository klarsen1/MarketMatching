...
This Vignette has three main sections, in the following order:

1. High level overview of the methodology.

2. Examples and installation instructions.

3. Details about the theory behind dynamic time warping (`dtw` package) and causal inference based on Bayesian structural time series models (`CausalImpact` package).
